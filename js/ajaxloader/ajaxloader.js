...
function AjaxLoader(id, options) {
    ...
    if (options !== null) {
        ...
        color  = HexToRGB(
            "color" in options ? options.color : defaultOptions.color);
    ...
    if (canvas === null) {
        console.log(
            "AjaxLoader Error! Cannot find canvas element by id '" + id + "'");
        return null;
    }
        ...
        for (var i = 0; i < segments; i++) {
            ...
            if (clockwise) {
                context.fillStyle = "rgba(" + color.r + "," + color.g + "," +
                    color.b + "," + (segments - 1 - i) / (segments - 1) + ")";
            } else {
                context.fillStyle = "rgba(" + color.r + "," + color.g + "," +
                    color.b + "," + i / (segments - 1) + ")";
            }
